...
if __name__=='__main__':
    ...
    while True:
        ...
        braitenbergL=[-1.4,-1.6,-1.8,-2.0,-2.2,0.0,0.0,0.0,0.0]
        braitenbergR=[-2.2,-2.0,-1.8,-1.6,-1.4,0.0,0.0,0.0,0.0]
        ...
        if(min(front_scan)<=0.6 and vLeft==vRight):
            pepper.moveTo(0.0,0.0,math.pi/2,_async=True)
            time.sleep(1)
        elif(min(front_scan)<=0.6):
            x=(vLeft+vRight)/2
            R=0.1
